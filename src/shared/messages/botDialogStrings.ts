...
export enum BotCommandOptionInfo {
  ...
  GetAllUserSessions_SessionMessageIDName = 'user-session-message-id',
  GetAllUserSessions_SessionMessageIDDescription = 'discord message id for session',
  GetAllSessions_SessionMessageIDName = 'all-sessions-message-id',
  ...
  GetAllUsersInASession_UserRoleName = 'user-role-in-session',
